...
try:
    ...
    cursor.execute(f"select CELL, CELL_TYPE, DISEASE, UMAP_1, UMAP_2 from DATA_CELLUMAP WHERE scARE_ID = '{Dataset}' ")
    info=cursor.fetchall()


    info=pd.DataFrame(info,columns=['CELL','CELL_TYPE', 'DISEASE','UMAP_1','UMAP_2'])
